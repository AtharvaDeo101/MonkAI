      ...
      <div className="relative z-10 w-full max-w-md px-4">
        ...
        >
          ...
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-gradient-to-r from-[#5F85DB]/10 to-[#FF6B6B]/10 border border-[#5F85DB]/20 mb-4">
            ...
            <span className="text-sm text-[#FAF7F0]/80">Join MonkAI Today</span>
          </div>
          <h1 className="text-3xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-[#FAF7F0] via-[#5F85DB] to-[#FF6B6B] mb-2">
            Create Your Account
          </h1>
          <p className="text-[#FAF7F0]/60">Start creating amazing music with AI</p>
        </motion.div>
        ...
        >
          <Card className="bg-[#26282B]/50 border-[#26282B] backdrop-blur-sm shadow-xl">
            <CardHeader>
              <CardTitle className="text-[#FAF7F0] text-center">Sign Up</CardTitle>
            </CardHeader>
            <CardContent>
              {error && (
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <div>
                  ...
                  <div className="relative">
                    <User className="absolute left-3 top-1/2 transform -translate-y-1/2 text-[#5F85DB] w-4 h-4" />
                    <Input
                      id="name"
                      name="name"
                      type="text"
              ...
              <div className="mt-6 text-center">
                <p className="text-[#FAF7F0]/60">
                  ...
                  <Link href="/login" className="text-[#5F85DB] hover:text-[#FF6B6B] transition-colors">
                    Sign in
                  </Link>
                </p>
              </div>
